...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_2.privateProcedure
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var user, productIds, payload, products, filteredProductIds, order, line_items, stripeSession, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        filteredProductIds = products.filter(function (product) {
                        ...
                        return [4 /*yield*/, payload.create({
                                ...
                                data: {
                                    _isPaid: false,
                                    products: filteredProductIds.map(function (prod) { return prod.id; }),
                                    user: user.id,
                                },
                            })];
                    case 3:
                        order = _b.sent();
                        line_items = [];
                        filteredProductIds.forEach(function (product) {
                            line_items.push({
                        ...
                        line_items.push({
                            price: "price_1OSx15SB3sYJzaHARVnvyIpU",
                            quantity: 1,
                            adjustable_quantity: {
                                enabled: true,
                            },
    ...
    pollOrderStatus: trpc_2.privateProcedure
